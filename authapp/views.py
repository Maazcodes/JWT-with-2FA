...
from authapp.serializer import EmployeeSerializer
...
class EmployeeViewSet(
    GenericViewSet, generics.ListCreateAPIView, generics.RetrieveUpdateDestroyAPIView
):
...
class CustomTokenObtainPairView(TokenObtainPairView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if (
            user.is_twofa_on()
        ):  # if user is 2FA registered (authy phone number and authy id is present)
